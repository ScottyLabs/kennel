  ...
  internal = rec {
    ...
    crates = {
      ...
      "reqwest 0.12.28" = rec {
        ...
        resolvedDefaultFeatures = [ "__rustls" "__rustls-ring" "__tls" "default-tls" "json" "multipart" "rustls-tls" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" ];
      };
      "reqwest 0.13.2" = rec {
        crateName = "reqwest";
        version = "0.13.2";
